...
namespace DustMother.App
{
    ...
    {
        private XboxGameBarWidget _campaignWidget = null;
        private XboxGameBarWidget _conquestWidget = null;
        ...
        private void App_UnhandledException(object sender, Windows.UI.Xaml.UnhandledExceptionEventArgs e)
        {
            e.Handled = true;
            var d = e.Exception;
            Debug.WriteLine("Stack Trace 1:" + d.StackTrace);
            Debug.WriteLine("Stack Trace 2:" + d.StackTrace);
            throw e.Exception;
        }
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            if (widgetArgs != null)
            {
                ...
                if (widgetArgs.IsLaunchActivation)
                {
                    ...
                    if (widgetArgs.AppExtensionId == "DustMotherCampaignOverlay5")
                    {
                        _campaignWidget = new XboxGameBarWidget(
                            widgetArgs,
                            Window.Current.CoreWindow,
                            rootFrame);
                        //_campaignWidget.TryResizeWindowAsync(new Size(400, 400));
                        rootFrame.Navigate(typeof(Widgets.MainWidget), new WidgetHandle { Widget = _campaignWidget, Window = Window.Current.CoreWindow });

                        Window.Current.Closed += CampaignWidgetWindow_Closed;
                    }
                    //else if (widgetArgs.AppExtensionId == "DustMotherConquestOverlay")
                    //{
                    //    _conquestWidget = new XboxGameBarWidget(
                    //        widgetArgs,
                    //        Window.Current.CoreWindow,
                    //        rootFrame);
                    //    rootFrame.Navigate(typeof(ConquestWidget));

                    //    Window.Current.Closed += ConquestWidgetWindow_Closed;
                    //}
                    else
                    {
                ...
                else if (widgetArgs.AppExtensionId == "DustMotherConquestOverlay")
                {
                    ...
                    rootFrame.NavigationFailed += OnNavigationFailed;
                    //rootFrame.Navigate(typeof(ConquestWidget), widgetArgs.Uri);
                }
            }
        }
        ...
        private void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            _conquestWidget = null;
            _campaignWidget = null;
            deferral.Complete();
        }

        private void CampaignWidgetWindow_Closed(object sender, Windows.UI.Core.CoreWindowEventArgs e)
        {
            _campaignWidget = null;
            Window.Current.Closed -= CampaignWidgetWindow_Closed;
        }

        private void ConquestWidgetWindow_Closed(object sender, Windows.UI.Core.CoreWindowEventArgs e)
        {
            _campaignWidget = null;
            Window.Current.Closed -= ConquestWidgetWindow_Closed;
        }
